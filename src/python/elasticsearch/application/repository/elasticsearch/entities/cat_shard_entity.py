...
class ShardEntity(BaseModel):
    id: Optional[str]   = Field(None, title="Node ID")
    ...
    node: Optional[str] = Field(None, title="Shard located node")
    store: Optional[str]= Field(None, title="Shard store size")
    docs: Optional[str] = Field(None, title="Shard docs size")
